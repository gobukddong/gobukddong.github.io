...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#050505] text-white pt-12 p-4 sm:p-8 md:p-12 lg:p-24 selection:bg-blue-500/30">
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        <section id="videos" className="space-y-8 scroll-mt-12">
          <div className="border-b border-neutral-800 pb-4">
            <h2 className="text-2xl md:text-3xl font-bold font-outfit uppercase tracking-widest text-transparent bg-clip-text bg-[linear-gradient(to_bottom,#e8e8e8_0%,#ffffff_20%,#888888_40%,#cccccc_55%,#aaaaaa_70%,#ffffff_85%,#999999_100%)]">
              Videos
            </h2>
          </div>
          <VideoGrid />
